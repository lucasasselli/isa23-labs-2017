...
analyze -library WORK -format vhdl {../hdl/booth_mult_pkg.vhd}
analyze -library WORK -format vhdl {../hdl/ha.vhd}
analyze -library WORK -format vhdl {../hdl/fa.vhd}
analyze -library WORK -format vhdl {../hdl/rca.vhd}
analyze -library WORK -format vhdl {../hdl/booth_encoder.vhd}
analyze -library WORK -format vhdl {../hdl/dadda_plane.vhd}
analyze -library WORK -format vhdl {../hdl/booth_mult.vhd}
...
# Set constraints
create_clock -name MY_CLK -period 2.27 CLK
...
ungroup -all -flatten
write -hierarchy -format verilog -output netlist/filter_top_Dadda_trunc.v
