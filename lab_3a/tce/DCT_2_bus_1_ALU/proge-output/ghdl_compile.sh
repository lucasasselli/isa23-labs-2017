...
ghdl -i --workdir=work vhdl/xilinx_rams_14.vhd
ghdl -i --workdir=work vhdl/sramrf_1wr_1rd_always_1.vhd
...
ghdl -i --workdir=work gcu_ic/output_socket_2_1.vhdl
ghdl -i --workdir=work gcu_ic/input_socket_2.vhdl
