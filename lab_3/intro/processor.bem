...
<adf-encoding required-version="1.2" version="1.2">
  ...
  <map-ports name="LIFR_i1">
    <extra-bits>0</extra-bits>
    <fu-port-code fu="LIFT" name="P1" operation="lift_pi16_1">
      <encoding>0</encoding>
      <extra-bits>3</extra-bits>
    </fu-port-code>
    <fu-port-code fu="LIFT" name="P1" operation="lift_pi16_2">
      <encoding>1</encoding>
      <extra-bits>2</extra-bits>
    </fu-port-code>
    <fu-port-code fu="LIFT" name="P1" operation="lift_pi316_1">
      <encoding>2</encoding>
      <extra-bits>1</extra-bits>
    </fu-port-code>
    <fu-port-code fu="LIFT" name="P1" operation="lift_pi316_2">
      <encoding>3</encoding>
      <extra-bits>1</extra-bits>
    </fu-port-code>
    <fu-port-code fu="LIFT" name="P1" operation="lift_pi8_1">
      <encoding>4</encoding>
      <extra-bits>0</extra-bits>
    </fu-port-code>
    <fu-port-code fu="LIFT" name="P1" operation="lift_pi8_2">
      <encoding>5</encoding>
      <extra-bits>0</extra-bits>
    </fu-port-code>
  </map-ports>
  ...
  <slot name="B1">
    ...
    <destination>
      ...
      <socket name="LIFR_i1">
        <map codes="LIFR_i1" extra-bits="0">4</map>
      </socket>
      <socket name="bool_i1">
        <map codes="bool_i1" extra-bits="0">20</map>
      </socket>
      <socket name="gcu_i1">
        <map codes="gcu_i1" extra-bits="0">21</map>
      </socket>
      <socket name="lsu_i2">
