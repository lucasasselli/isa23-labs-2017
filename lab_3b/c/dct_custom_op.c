...
void ls(sample_t *x, volatile sample_t *y)
{
  ...
  ytmp1 = x[6];
  ytmp2 = x[5];
  _TCE_LIFT_PI8_1(ytmp1, ytmp2, ytmp1);
  _TCE_LIFT_PI8_2(ytmp1, ytmp2, ytmp2);
  _TCE_LIFT_PI8_1(ytmp1, ytmp2, ytmp1);
  y[2] = ytmp1;
  y[6] = ytmp2;
  ...
  ytmp3 = x[7];
  ytmp4 = x[1];
  _TCE_LIFT_PI8_1(ytmp3, ytmp4, ytmp3);
  _TCE_LIFT_PI8_2(ytmp3, ytmp4, ytmp4);
  _TCE_LIFT_PI8_1(ytmp3, ytmp4, ytmp3);

  _TCE_LIFT_PI16_1(ytmp1, ytmp4, ytmp1);
  _TCE_LIFT_PI16_2(ytmp1, ytmp4, ytmp4);
  _TCE_LIFT_PI16_1(ytmp1, ytmp4, ytmp1);

  _TCE_LIFT_PI316_1(ytmp2, ytmp3, ytmp2);
  _TCE_LIFT_PI316_2(ytmp2, ytmp3, ytmp3);
  _TCE_LIFT_PI316_1(ytmp2, ytmp3, ytmp2);
